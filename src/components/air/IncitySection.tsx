  ...
  return (
    <section className="py-8 sm:py-12 lg:py-16 px-4 sm:px-6 lg:px-8 bg-[#F8F7F4]">
      <div className="max-w-6xl mx-auto">
        ...
        <motion.div 
          className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center mb-12 sm:mb-16 lg:mb-20"
          ...
          <div className="relative order-1 lg:order-1 flex justify-center">
            <div className="relative">
              <Image
                ...
                width={280}
                height={700}
                className="w-24 sm:w-28 lg:w-[280px] h-auto object-contain hover:scale-105 transition-transform duration-700"
                style={{ 
                  filter: 'drop-shadow(0 10px 25px rgba(0, 0, 0, 0.1))',
                }}
              />
              {/* Effet de fond décoratif cohérent avec la section du bas */}
              <div className="absolute -inset-2 sm:-inset-4 bg-gradient-to-r from-[#46952C]/20 to-blue-500/20 rounded-2xl sm:rounded-3xl blur-xl opacity-30 -z-10"></div>
            </div>
          </div>
        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 lg:gap-12 items-center">
            ...
            <div className="order-2 lg:order-1 text-center lg:text-left px-2 sm:px-0">
              <h4 className="text-lg sm:text-xl lg:text-2xl font-light text-black mb-4 sm:mb-6 leading-tight">
...
>
  ...
  >
    <div className="flex items-center justify-center gap-2 sm:gap-3">
      ...
      <span className="text-center">Télécharger l&apos;app EcoLyon</span>
    </div>
  </ShinyButton>
</a>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative z-10">
                  <Image
                    ...
                    width={400}
                    height={800}
                    className="w-64 sm:w-72 lg:w-84 h-auto drop-shadow-2xl"
                  />
                </div>
