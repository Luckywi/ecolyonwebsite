// src/app/qualite-air/PM10/page.tsx
"use client";
...
export default function PM10DetailPage() {
    ...
    return (
      <div className="min-h-screen bg-[#F8F7F4] py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl text-black">Chargement des données PM10...</p>
        </div>
      </div>
    );
  }
  ...
  <div className="backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100">
    ...
    <div className="flex items-center justify-between mb-6">
      <div>
        ...
        <p className="text-gray-600">Particules PM10 mesurées</p>
      </div>
