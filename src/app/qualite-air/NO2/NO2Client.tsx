// src/app/qualite-air/NO2/NO2Client.tsx
"use client";
...
export default function NO2Client() {
  ...
  useEffect(() => {
    const fetchNO2Data = async () => {
      try {
        ...
        console.error('Erreur lors du chargement des données NO2:', error);
    ...
    return (
      <div className="min-h-screen bg-[#F8F7F4] py-4 sm:py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-lg sm:text-xl text-black">Chargement des données NO2...</p>
        </div>
      </div>
    );
  }
          ...
          <div className="backdrop-blur-sm rounded-2xl p-4 sm:p-6 shadow-lg border border-gray-100">
            ...
            <div className="flex items-center justify-between gap-4 mb-6">
              <div className="flex-1">
                ...
                <p className="text-gray-600 text-sm sm:text-base">Dioxyde d&apos;azote NO2 mesuré</p>
              </div>
