// src/app/qualite-air/SO2/page.tsx
"use client";
...
export default function SO2DetailPage() {
    ...
    return (
      <div className="min-h-screen bg-[#F8F7F4] py-8 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl text-black">Chargement des données SO2...</p>
        </div>
      </div>
    );
  }
  ...
  <div className="bg-white/30 backdrop-blur-sm rounded-2xl p-6 shadow-lg border border-gray-100">
    ...
    <div className="flex items-center justify-between mb-6">
      <div>
        ...
        <p className="text-gray-600">Dioxyde de soufre SO2 mesuré</p>
      </div>
