// src/app/infrastructure/InfrastructureClient.tsx
"use client";
...
export default function InfrastructureClient() {
  ...
  return (
   <div className="min-h-screen bg-[#F8F7F4] relative overflow-hidden">
      {/* Globe d'icônes en arrière-plan - Responsive avec props personnalisées */}
      <div className="absolute top-3 inset-x-0 z-0 mx-auto">
        {/* Version Desktop */}
        <div className="hidden md:flex w-[600px] h-[600px] mx-auto items-center justify-center">
          <IconCloud 
            images={images}
            iconSize={95}
            radius={200}
        ...
        <div className="md:hidden w-[350px] h-[350px] sm:w-[400px] sm:h-[400px] mx-auto flex items-center justify-center">
          <IconCloud 
            images={images}
            iconSize={75} // Icônes plus petites
            radius={140} // Rayon plus petit
            canvasSize={350} // Canvas plus petit
          />
        </div>
        
        {/* Version Tablette Medium */}
        <div className="hidden sm:flex md:hidden w-[400px] h-[400px] mx-auto items-center justify-center">
          <IconCloud 
            images={images}
            iconSize={55}
            radius={160}
      ...
      {/* Contenu principal - Responsive margin ajustée */}
      <div className="relative z-10 bg-[#F8F7F4] mt-[200px] sm:mt-[250px] md:mt-[370px]">
        ...
        <section className="py-8 md:py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            {error ? (
              ...
              <p className="text-lg sm:text-xl md:text-2xl lg:text-3xl font-light text-black">
        ...
        <section className="py-4 px-4 sm:px-6 lg:px-8 bg-[#F8F7F4]">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              {/* Bouton de téléchargement centré - Responsive */}
              <a 
...
>
              <ShinyButton 
                className="bg-ecolyon-green hover:bg-ecolyon-green-dark text-white px-6 py-3 md:px-8 md:py-4 rounded-xl font-medium text-sm md:text-base shadow-lg hover:shadow-xl border-ecolyon-green"
                style={{ 
                  '--primary': '#46952C',
